  ...
  bindEvents() {
    ...
    root.addEventListener("input", (e) => {
      ...
      if (el.dataset && el.dataset.field) {
        ...
        // formulários com rascunho (contato / atividade da agenda / zoom / pessoa da Reunião de Foco / ascendente / S.O.S. / contato de evento / patrocinador(a) via FAB / sócio): também não re-renderizam, para não perder o foco
