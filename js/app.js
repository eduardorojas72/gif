  ...
  bindEvents() {
    ...
    root.addEventListener("input", (e) => {
      ...
      if (el.dataset && el.dataset.field) {
        ...
        // formularios con borrador (contact / activitate din agendă / zoom / persoană din Întâlnirea de Focalizare / ascendent / S.O.S. / contact din eveniment / sponsor din FAB / partener): nici acestea nu se re-randează, ca să nu se piardă focusul
