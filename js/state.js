...
/* ---------------- My Partners — permanent directory of my team, by Left/Right line ---------------- */
...
/* Full months elapsed from an ISO date to today (null if there's no date).
   Used to flag when a partner has gone ~11 months without buying and is about to expire. */
...
/* Adds calendar months to an ISO date (used for the "11 months" Customers follow-up). */
...
/* Customers whose birthday (day and month) is today — for the floating birthday alert. */
