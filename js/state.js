...
function hydrateState(parsed) {
  ...
  merged.contactos = Array.isArray(parsed.contactos)
    ? parsed.contactos.map((c) =>
        Object.assign(
          { id: "c" + Math.random().toString(36).slice(2, 9), nombre: "", telefono: "", pais: "", nivel: "Tiepido", estado: "Da contattare", notas: "", notaSeguimiento: "", proximoSeguimiento: null, creado: hoyISO() },
          c
        )
      )
    : [];
