...
/* ---------------- Mis Socios — directorio permanente de mi equipo, por línea izquierda/derecha ---------------- */
...
/* Meses completos transcurridos desde una fecha ISO hasta hoy (null si no hay fecha).
   Se usa para avisar cuándo un socio lleva ~11 meses sin comprar y está por caducar. */
...
/* Suma meses de calendario a una fecha ISO (para el seguimiento a "11 meses" de Clientes). */
...
/* Clientes cuyo cumpleaños (día y mes) es hoy — para el aviso flotante. */
