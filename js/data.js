...
const OCHO_PASOS = [
  ...
  },
  {
    ...
    duplicaChecklist: [
      "He descargado la aplicación oficial de Atomy.",
      "Hago los 8 pasos.",
      "He hecho un pedido para domicilio.",
      "He hecho un pedido para recoger en un centro de educación.",
      "He hecho un pedido grupal.",
      "He registrado compradores.",
      "He registrado distribuidores.",
      "He registrado distribuidores en países de preregistro.",
      "Visito mi página cada día.",
      "Visualizo las novedades.",
      "Visualizo mis compras personales y cambio las fechas de compra.",
      "Sé cómo se anula o modifica un pedido.",
      "Sé cómo devolver productos.",
      "Hago cambios en mi cuenta personal de consumidor a distribuidor.",
      "Subo los documentos que solicita la empresa para cobrar mis comisiones.",
      "Visualizo las compras de equipo y entiendo cómo ciclar.",
...
const ENLACES_UTILES = [
  { nombre: "Aplicación Atomy para Android", url: "https://play.google.com/store/apps/details?id=com.atomy.android.shop&hl=es" },
  { nombre: "Aplicación Atomy para iPhone", url: "https://apps.apple.com/es/app/official-atomy-shop/id1637879180" },
  { nombre: "Klarna", url: "https://www.klarna.com/es/" },
  { nombre: "PayPal", url: "https://www.paypal.com/es/home" },
  { nombre: "Página oficial de Atomy", url: "https://eu.atomy.com/main" },
  ...
  },
  {
    ...
    contenido: [
      ...
      },
      {
        h: "Tu video de hoy",
        body: [
          "Video de ayuda — ¿Cómo registrar un distribuidor?: https://ch.atomy.com/co/1541?categoryId=52&listType=100&page=2&tags=&orderType=FILMING",
...
const RANK_SHARE_TEXTS = [
  ...
  "🏆 ¡SUEÑO CUMPLIDO: NUEVO SALES MASTER! 🏆\n\n¡Llegamos a lo más alto! Alcanzar la maestría de SALES MASTER es el reconocimiento a la disciplina, la entrega y, sobre todo, al trabajo en equipo. 🔥💎\n\nEste no es un logro individual; es el resultado de ayudar a decenas de familias a consumir con inteligencia, sustituyendo productos cotidianos por calidad premium a precio justo. Cuando ayudas a otros a ganar, la maestría llega como consecuencia natural.\n\nSales Master es la prueba de que el sistema funciona, que la perseverancia paga y que esto es solo el comienzo de un impacto masivo. 🌍✨\n\nA cada miembro del equipo, a mis patrocinadores y a quienes creyeron en la visión desde el día uno: ¡gracias de corazón! La cumbre se escala en equipo. 👥💙\n\n💬 ¿Listo para construir algo verdaderamente tuyo? Escríbeme \"CUMBRE\" por privado y te enseño a trazar tu propio plan de éxito.",
];
