...
function renderPasos(state, ui) {
  ...
  return header +
    videoRowHTML({ titulo: "Os 8 Passos para o Sucesso (vídeo)", url: "https://www.youtube.com/watch?v=z-Nzz1HkoE8" }) +
...
function renderContactos(state, ui) {
  ...
  return (
    ...
    '<button class="btn-primary" data-action="add-contacto">' + Icon("phone-call", { size: 16, color: "#fff" }) + " Novo contato</button>" +
