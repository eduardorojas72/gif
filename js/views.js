...
function renderArbolGenealogico(state, ui) {
  ...
  return (
    ...
    '<div class="field"><label>Data nașterii</label><input type="date" data-field="arbolGenealogico.yo.fechaNacimiento" value="' + escapeHtml(yo.fechaNacimiento || "") + '"></div>' +
    "</div></div>" +
    ...
    "</div>" +
    '<div class="field"><label>Data nașterii</label><input type="date" data-field="arbolGenealogico.patrocinador.fechaNacimiento" value="' + escapeHtml(p.fechaNacimiento || "") + '"></div>' +
    '<div class="row gap-2">' +
